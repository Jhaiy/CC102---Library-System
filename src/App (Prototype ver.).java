...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String[] adminCommands = {"Add a new book", "Remove a book", "See list of borrowers", "View suggestions", "Log-out", "Ban user"};
            ...
            if (doesUserHaveAcc.equals("y")) {
                ...
                if (checkAccount(username, password) == null
                    ...
                    switch (adminCommand) {
                        ...
                        case "6":
                            for (String i : registeredAcc.keySet()){
                                System.out.println(i + registeredAcc.get(i));
                            }
                            System.out.println("Which user yould you like to ban?");
                            String name = input.nextLine();
                            if (registeredAcc.keySet().contains(name)){
                                registeredAcc.keySet().remove(name);
                            } else {
